KPLIB_objectInits = [
    ...
    [
        ["RHS_MELB_AH6M"],
        {   
            [_this] execVM "scripts\pylons\ah6mmpylons.sqf";
        }
    ],
    [
        ["RHS_MELB_AH6M_L"],
        {   
            [_this] execVM "scripts\pylons\ah6lpylons.sqf";
        }
    ],
    [
        ["RHS_MELB_AH6M_M"],
        {   
            [_this] execVM "scripts\pylons\ah6mpylons.sqf";
        }
    ],
    [
        ["RHS_MELB_AH6M_H"],
        {   
            [_this] execVM "scripts\pylons\ah6hpylons.sqf";
        }
    ],
    [
        ["RHS_AH1Z_wd"],
        {
            [_this] execVM "scripts\pylons\ah1zpylons.sqf";
        }
    ],
    [
        ["vtx_MH60M_DAP"],
    ...
    [
        ["fza_ah64d_b2e_nr"],
        {   
            [_this] execVM "scripts\pylons\ah64nrpylons.sqf";
        }
    ],
    [
        ["fza_ah64d_b2e"],
    ...
    [
        ["RHS_UH1Y"],
        {   
            [_this] execVM "scripts\pylons\uh1ypylons.sqf";
        }
    ],
    [
        ["USAF_A10"],
    ...
    [
        ["USAF_F22"],
        {   
            [_this] execVM "scripts\pylons\f22pylons.sqf";
        }
    ],
    [
        ["USAF_F22_Heavy"],
        {   
            [_this] execVM "scripts\pylons\f22hpylons.sqf";
        }
    ],
    [
        ["USAF_F35A"],
    ...
    [
        ["USAF_F35A_STEALTH"],
        {   
            [_this] execVM "scripts\pylons\f35spylons.sqf";
        }
    ],
    [
        ["USAF_F35A_LIGHT"],
        {   
            [_this] execVM "scripts\pylons\f35lpylons.sqf";
        }
    ],
    [
    ...
    [
        ["FIR_AV8B_VMA214_04"],
        {   
            [_this] execVM "scripts\pylons\av8bpylons.sqf";
    ...
    [
        ["FIR_F16C_AS_2"],
        {   
            [_this] execVM "scripts\pylons\f16akpylons.sqf";
            // fuck the f-18 devs, good mod but stupid decisions...
            missionNamespace setVariable ["js_jc_fa18_serviceMenuObjects", ["NoMoreFuckingPylonEditing"]];
        }
    ],
    [
        ["FIR_F16C_ANG_FS"],
        {   
            [_this] execVM "scripts\pylons\f16arkpylons.sqf";
            // fuck the f-18 devs, good mod but stupid decisions...
            missionNamespace setVariable ["js_jc_fa18_serviceMenuObjects", ["NoMoreFuckingPylonEditing"]];
        }
    ],
    [
        ["FIR_F16C_ANG_SI"],
        {   
            [_this] execVM "scripts\pylons\f16illpylons.sqf";
            // fuck the f-18 devs, good mod but stupid decisions...
            missionNamespace setVariable ["js_jc_fa18_serviceMenuObjects", ["NoMoreFuckingPylonEditing"]];
        }
    ],
    [
        ["FIR_F16C_ANG_TX"],
        {   
            [_this] execVM "scripts\pylons\f16txpylons.sqf";
            // fuck the f-18 devs, good mod but stupid decisions...
            missionNamespace setVariable ["js_jc_fa18_serviceMenuObjects", ["NoMoreFuckingPylonEditing"]];
        }
    ],
    [
        ["FIR_F16C_ANG_WI"],
        {   
            [_this] execVM "scripts\pylons\f16wispylons.sqf";
            // fuck the f-18 devs, good mod but stupid decisions...
            missionNamespace setVariable ["js_jc_fa18_serviceMenuObjects", ["NoMoreFuckingPylonEditing"]];
        }
    ],
    [
        ["FIR_F16C_Interim"],
        {   
            [_this] execVM "scripts\pylons\f16blkpylons.sqf";
            // fuck the f-18 devs, good mod but stupid decisions...
            missionNamespace setVariable ["js_jc_fa18_serviceMenuObjects", ["NoMoreFuckingPylonEditing"]];
        }
    ],
    [
        ["FIR_F16C_ANG_MO"],
        {   
            [_this] execVM "scripts\pylons\f16monpylons.sqf";
            // fuck the f-18 devs, good mod but stupid decisions...
            missionNamespace setVariable ["js_jc_fa18_serviceMenuObjects", ["NoMoreFuckingPylonEditing"]];
        }
    ],
    [
        ["FIR_F18C_VFA131CAG"],
        {   
            [_this] execVM "scripts\pylons\f18cagpylons.sqf";
            // fuck the f-18 devs, good mod but stupid decisions...
            missionNamespace setVariable ["js_jc_fa18_serviceMenuObjects", ["NoMoreFuckingPylonEditing"]];
        }
    ],
    [
        ["FIR_F18C_MAG31_WW2"],
        {   
            [_this] execVM "scripts\pylons\f18Dpylons.sqf";
            // fuck the f-18 devs, good mod but stupid decisions...
            missionNamespace setVariable ["js_jc_fa18_serviceMenuObjects", ["NoMoreFuckingPylonEditing"]];
        }
    ],
    [
        ["FIR_F15E"],
        {   
            [_this] execVM "scripts\pylons\f15strikeeaglepylons.sqf";
            // fuck the f-18 devs, good mod but stupid decisions...
            missionNamespace setVariable ["js_jc_fa18_serviceMenuObjects", ["NoMoreFuckingPylonEditing"]];
        }
    ],
    [
        ["FIR_F18C_VFA15_75year"],
        {   
            [_this] execVM "scripts\pylons\F18C_VFA15_75yearpylons.sqf";
            // fuck the f-18 devs, good mod but stupid decisions...
            missionNamespace setVariable ["js_jc_fa18_serviceMenuObjects", ["NoMoreFuckingPylonEditing"]];
        }
    ],
    [
        ["FIR_F18C_MALS31"],
        {   
            [_this] execVM "scripts\pylons\f18Yellpylons.sqf";
            // fuck the f-18 devs, good mod but stupid decisions...
            missionNamespace setVariable ["js_jc_fa18_serviceMenuObjects", ["NoMoreFuckingPylonEditing"]];
        }
    ],
    [
        ...
        {   
            [_this] execVM "scripts\VehicleLoadouts\m1a2sep2wd_Loadout.sqf";
        }
    ],
    [
        ["rhsusf_m1a2sep1tuskiiwd_usarmy"],
        {   
            [_this] execVM "scripts\VehicleLoadouts\m1a2sep1tuskiiwd_Loadout.sqf";
        }
    ],
    [
        ["RHS_M2A3_BUSKIII_wd"],
        {   
            [_this] execVM "scripts\VehicleLoadouts\M2A3_BUSKIII_Loadout.sqf";
        }
    ],
    [
        ["RHS_M2A3_wd"],
        {   
            [_this] execVM "scripts\VehicleLoadouts\M2A3_Loadout.sqf";
        }
    ],
    //
    [
        ...
        {   
            [_this] execVM "scripts\VehicleLoadouts\M1126_MK19_Loadout.sqf";
        }
    ],
    [
        ["rhsusf_m1151_m2crows_usarmy_d"],
        {   
            [_this] execVM "scripts\VehicleLoadouts\m1151_m2crows_Loadout.sqf";
        }
    ],
    [
        ["rhsusf_m1151_mk19crows_usarmy_d"],
        {   
            [_this] execVM "scripts\VehicleLoadouts\M1151A1 CROWSMk19_Loadout.sqf";
        }
    ],
    [
        ["rhsusf_stryker_m1134_d"],
        {   
            [_this] execVM "scripts\VehicleLoadouts\stryker_m1134_wd_Loadout.sqf";
        }
    ],
    //
    [
    ...
    [
        ["pook_CRAM_BASE"],
        {   
            [_this] execVM "scripts\VehicleLoadouts\CRAM_BASE_Loadout.sqf";
        }
    ],
    [
        ["pook_NASAMS_BASE"],
        {   
            [_this] execVM "scripts\VehicleLoadouts\NASAMS_BASE_Loadout.sqf";
        }
    ],
    [
        ["JS_JC_FA18E"],
        {   
            [_this] execVM "scripts\pylons\f18epylons.sqf";
            // fuck the f-18 devs, good mod but stupid decisions...
            missionNamespace setVariable ["js_jc_fa18_serviceMenuObjects", ["NoMoreFuckingPylonEditing"]];
        }
    ],
    ...
    [
        ["USAF_MQ9"],
        {   
            [_this] execVM "scripts\pylons\mq9pylons.sqf";
    ...
    [
        ...
        {   
            [_this] execVM "scripts\pylons\UAV_UCAVipylons.sqf";
            _this setVariable ["LESH_canBeTowed", 1];  
    	    _this setVariable ["LESH_towFromFront", 1];  
    	    _this setVariable ["LESH_AxisOffsetTarget", [0,8,-0.8]];  
            _this setVariable ["LESH_WheelOffset", [0,-1.5]];
    ...
    [
        ...
        {   
            [_this] execVM "scripts\pylons\MQ-12Falconpylons.sqf";
            _this setVariable ["LESH_canBeTowed", 1];  
    	    _this setVariable ["LESH_towFromFront", 1];  
    	    _this setVariable ["LESH_AxisOffsetTarget", [0,8,-0.8]];  
            _this setVariable ["LESH_WheelOffset", [0,-1.5]];
