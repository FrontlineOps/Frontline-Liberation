...
opfor_officer = "UK3CB_CSAT_W_O_FIELD_OFF";                          // Officer 
opfor_squad_leader = "UK3CB_CSAT_W_O_SL";                     // Sergeant 
opfor_team_leader = "UK3CB_CSAT_W_O_TL";                    		// Junior Sergeant 
opfor_sentry = "UK3CB_CSAT_W_O_RIF_1";                            // Efreitor 
opfor_rifleman = "UK3CB_CSAT_W_O_RIF_1";                            // Rifleman 
opfor_rpg = "UK3CB_CSAT_W_O_AT";                                // Rifleman w/ RPG-26 
opfor_grenadier = "UK3CB_CSAT_W_O_GL";                            	// Grenadier w/ GP-25 
opfor_machinegunner = "UK3CB_CSAT_W_O_MG";				// Autorifleman (PKP)
opfor_heavygunner = "UK3CB_CSAT_W_O_LMG";                 // Machinegunner 
opfor_marksman = "UK3CB_CSAT_W_O_SNI_GHILLIE";                              	// Marksman 
opfor_sharpshooter = "UK3CB_CSAT_W_O_SNI_HEAVY";                           // Sharpshooter 
opfor_sniper = "UK3CB_CSAT_W_O_SNI";                                	// Sniper 
opfor_at = "UK3CB_CSAT_W_O_HAT";                                // AT Specialist 
opfor_aa = "UK3CB_CSAT_W_O_AA";                               	// AA Specialist 
opfor_medic = "UK3CB_CSAT_W_O_MD";                                    	// Medic 
opfor_engineer = "UK3CB_KDF_O_RADIO";                              // Engineer 
opfor_paratrooper = "UK3CB_CSAT_W_O_LAT";						// Rifleman w/ RShG2 
opfor_rto = "UK3CB_CSAT_W_O_UAV";									// Officer (Armored) EMR

// From exported arsenal
opfor_rto_loadout = [["rhs_weap_ak74m_zenitco01_b33","rhs_acc_dtk3","","rhs_acc_1p87",["rhs_30Rnd_545x39_7N10_2mag_AK",30],[],"rhs_acc_grip_rk6"],[],["rhs_weap_makarov_pm","","","",["rhs_mag_9x18_8_57N181S",8],[],""],["rhs_uniform_vkpo_gloves_alt",[["ACE_fieldDressing",1],["ACE_packingBandage",1],["ACE_morphine",1],["ACE_tourniquet",1],["rhs_mag_9x18_8_57N181S",1,8],["rhs_mag_rdg2_white",1,1]]],["rhs_6b45_off",[["rhs_mag_9x18_8_57N181S",2,8],["rhs_30Rnd_545x39_7N10_2mag_AK",2,30]]],["B_RadioBag_01_eaf_F",[]],"rhs_6b47_emr_1","rhs_facewear_6m2_1",["rhssaf_zrak_rd7j","","","",[],[],""],["ItemMap","","TFAR_fadak","ItemCompass","Itemwatch","rhs_1PN138"]];

// Enemy vehicles used by secondary objectives.
opfor_mrap = "UK3CB_CSAT_W_O_Tigr";                                 // GAZ-233011
opfor_mrap_armed = "UK3CB_CSAT_W_O_Tigr_STS";                    // GAZ-233014 (Armed)
opfor_transport_helo = "UK3CB_CSAT_W_O_Taru_covered";                    // Mi-8MT (Cargo)
opfor_transport_truck = "UK3CB_CSAT_W_O_Typhoon_transport_covered";                // KamAZ-5350 (Covered)
opfor_ammobox_transport = "UK3CB_CSAT_W_O_Typhoon_ammo";                   // KamAZ-5350 Flatbed
opfor_fuel_truck = "UK3CB_CSAT_W_O_Typhoon_fuel";                             // TZ-8-255B1 (Fuel)
opfor_ammo_truck = "UK3CB_CSAT_W_O_Typhoon_repair";                             // KamAZ-5350 (Ammo)
...
opfor_uniforms = [
	"UK3CB_CSAT_W_O_U_CombatUniform"
];
...
opfor_backpacks = [
	"UK3CB_CSAT_W_O_B_ASS"
];
// Force add a vest
opfor_vests = [
	"UK3CB_CSAT_W_O_V_Carrier_Rig_Light"
];
...
militia_squad = [
	"UK3CB_CSAT_W_O_SL",									// Sergeant 
	"UK3CB_CSAT_W_O_TL",										// Junior Sergeant 
	"UK3CB_CSAT_W_O_RIF_1",									// Efreitor 
	"UK3CB_CSAT_W_O_GL",										// Rifleman 
	"UK3CB_CSAT_W_O_GL",										// Rifleman 
	"UK3CB_CSAT_W_O_LMG",									// Rifleman 
	"UK3CB_CSAT_W_O_RIF_1",									// Rifleman 
	"UK3CB_CSAT_W_O_RIF_1",										// Rifleman 
	"UK3CB_CSAT_W_O_RIF_1",							// Rifleman w/ RPG-26 
	"UK3CB_CSAT_W_O_RIF_1",									// Rifleman w/ RPG-26 
	"UK3CB_CSAT_W_O_RIF_1",									// Rifleman w/ RShG2 
	"UK3CB_CSAT_W_O_GL",										// Grenadier w/ GP-25 
	"UK3CB_CSAT_W_O_GL",										// Grenadier w/ GP-25 
	"UK3CB_CSAT_W_O_GL",										// Grenadier w/ GP-25
	"UK3CB_CSAT_W_O_LAT",							// paradrop guy
	"UK3CB_CSAT_W_O_MG",								// Autorifleman (PKP) 
	"UK3CB_CSAT_W_O_LMG",								// Machinegunner 
	"UK3CB_CSAT_W_O_SNI_GHILLIE",										// Marksman 
	"UK3CB_CSAT_W_O_SNI_HEAVY",										// Sharpshooter 
	"UK3CB_CSAT_W_O_SNI",											// Sniper 
	"UK3CB_CSAT_W_O_MD",											// Medic 
	"UK3CB_CSAT_W_O_MD",											// Medic 
	"UK3CB_KDF_O_RADIO",										// Engineer 
	"UK3CB_KDF_O_RADIO",										// Engineer 
	"UK3CB_CSAT_W_O_AT",									// Grenadier w/ RPG-7V2 
	"UK3CB_CSAT_W_O_AT",									// Grenadier w/ RPG-7V2 
	"UK3CB_CSAT_W_O_HAT",									// AT Specialist 
	"UK3CB_CSAT_W_O_AA" 									// AA Specialist 
];
...
opfor_battlegroup_vehicles = [
	...
	"rhs_mi28n_vvsc",
	"RHS_Ka52_vvsc",                                           	// MIG
	"UK3CB_CSAT_W_O_Kajman_ClusterHE",
	"UK3CB_CSAT_W_O_Mi_24G_FAB", 
	"UK3CB_CSAT_W_O_Mi_24G_UPK23", 
	"UK3CB_CSAT_W_O_Kajman_Bomb", 
	"UK3CB_CSAT_W_O_Kajman_HeavyCAS", 
	"UK3CB_CSAT_W_O_Kajman", 
	...
	"RHS_T50_vvs_generic_ext",
	"UK3CB_CSAT_W_O_MIG29S",
	"UK3CB_CSAT_W_O_MIG29SM",
	"rhs_2s3_tv",
	"rhs_2s3_tv",
...
opfor_tanks = [
	...
	[80,	
		[	
			...
			"UK3CB_CSAT_W_O_ZSU39_Camo",													// T-80UM
			"UK3CB_CSAT_W_O_ZSU39_Camo"														// T-80UM
		]	
	],	
	[120,	
...
opfor_sams = [	
	...
	[120, 	
		[	
			"UK3CB_CW_SOV_O_LATE_MTLB_ZU23",
			"UK3CB_CW_SOV_O_LATE_MTLB_ZU23",
			"UK3CB_CSAT_W_O_ZSU39_Camo",												// ZSU-23-4V
...
BATTLESPACE_DEFENDERS_VEHICLE_CLASSES = [
	...
	"UK3CB_CW_SOV_O_LATE_MTLB_ZU23",
	"UK3CB_CW_SOV_O_LATE_MTLB_ZU23",
	"UK3CB_CSAT_W_O_ZSU39_Camo",									// rhs_zsu234_aa
