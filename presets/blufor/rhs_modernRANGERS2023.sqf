...
recon_vehicles = [
    ...
    ["rhsusf_m998_d_4dr",               75,      0,       75,     "Phantom M1097A2 (Recon)"],
...
artillery_vehicles = [     
    ...
    ["rhsusf_m109d_usarmy",         			1200,   1300,	700,	"Savage M109A6 Paladin"],
...
rotarycas_vehicles = [
    ...
    ["RHS_MELB_AH6M_H",				550,	700,	300,    "AH-6MH (HELLFIRE)"],
    ...
    ["vtx_MH60M_DAP",		       700,	    800,	800,	"MH-60M DAP"] 					// MH-60M DAP
];
