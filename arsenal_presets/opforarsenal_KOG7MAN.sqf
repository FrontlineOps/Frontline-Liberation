...
OpforArsenal_DetermineGear = {
	...
	if(_roleDesc find "Detachment Commander" > -1) then {////unused
		_gearToAdd = op_DetC;
	};
	...
	if(_roleDesc find "Assistant Team Leader" > -1) then {////unused
		_gearToAdd = op_ASTL;
	};
	...
	if(_roleDesc find "Machine Gunner" > -1) then {////unused
		_gearToAdd = op_HPKP;
	};
	...
	if(_roleDesc find "Launcher Specialist" > -1) then {////unused
		_gearToAdd = op_RPG;
	};

	if(_roleDesc find "Communications Specialist" > -1) then {//////unused
		_gearToAdd = op_COMMGUY;
	};

	if(_roleDesc find "Drone Specialist" > -1) then {//////unused
		_gearToAdd = op_EWAR;
	};

	if(_roleDesc find "Demolitions Specialist" > -1) then {//////unused
		_gearToAdd = op_Engineer;
	};

	if(_roleDesc find "Engineer Team Leader" > -1) then {//////unused
		_gearToAdd = op_Engineer;
	};

	if(_roleDesc find "Engineer-1" > -1) then {//////unused
		_gearToAdd = op_Engineer;
	};

	if(_roleDesc find "Engineer-2" > -1) then {//////unused
		_gearToAdd = op_Engineer;
	};

	if(_roleDesc find "SNOT Sniper" > -1) then {//////unused
		_gearToAdd = op_sniper;
	};

	if(_roleDesc find "SNOT Spotter" > -1) then {//////unused
		_gearToAdd = op_Spotter;
	};

	if(_roleDesc find "K11 Marksman" > -1) then {//////unused
		_gearToAdd = op_marksm;
	};

	if(_roleDesc find "K12 Marksman" > -1) then {//////unused
		_gearToAdd = op_marksm;
	};
	...
	if(_roleDesc find "Weapons Assistant Gunner" > -1) then {//////unused
		_gearToAdd = op_A_G;
	};

	if(_roleDesc find "Terminator 1 Team Leader" > -1) then {//////unused
		_gearToAdd = op_MORTORSTUFF + op_SL;
	};

	if(_roleDesc find "Terminator 1 Mortarman" > -1) then {//////unused
		_gearToAdd = op_MORTORSTUFF;
	};

	if(_roleDesc find "Terminator 1 Asst. Mortarman" > -1) then {//////unused
		_gearToAdd = op_MORTORSTUFF;
	};

	if(_roleDesc find "Flight" > -1) then {//////unused
		_gearToAdd = op_pilot;
	};
