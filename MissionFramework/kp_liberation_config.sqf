...
// Infrastructure and deep-recon evaluation. Convoy dispatch has its own cadence.
...
// Ground offensives retain the Battlegroup save identity. These are persistent,
