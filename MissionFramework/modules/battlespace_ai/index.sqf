...
[] call compileFinal preprocessFileLineNumbers "modules\battlespace_ai\theaters\index.sqf";
...
[] call compileFinal preprocessFileLineNumbers "modules\battlespace_ai\airlift\index.sqf";
