...
[
    ...
    "Seconds before enemy air-response planning begins after initialization. Initial scheduling only; requires a mission restart.",
    ["Frontline - Enemy Support", "Air support"],
    [1, 3600, 600, 0], false
] call _add;
