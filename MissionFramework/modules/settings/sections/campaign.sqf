...
[
    ...
    "Factory crate value",
    "Resource units in each pallet of a factory's initial cache, before the resource multiplier. Each cache contains 12 supply, 8 ammunition and 4 fuel pallets. Applies to newly issued depots; existing pallets are unchanged.",
    ["Frontline - Campaign", "Economy"],
    [1, 400, 100, 0], true
] call _add;
...
[
    ...
    "Resource multiplier",
    "Scale resource quantities in settlement loot, factory caches and convoy salvage crates. A value of 2 doubles their base crate values. Applies to new resource issuance; existing crates are unchanged.",
    ["Frontline - Campaign", "Economy"],
...
[
    ...
    "Scale ammunition costs in the automatically generated vehicle build catalog. A value of 2 doubles that part of the price. Generated catalog prices require a mission restart.",
    ["Frontline - Campaign", "Economy"],
    [0, 4, 1, 2], false
] call _add;
...
[
    ...
    "Scale fuel costs in the automatically generated vehicle build catalog. A value of 2 doubles that part of the price. Generated catalog prices require a mission restart.",
    ["Frontline - Campaign", "Economy"],
    [0, 4, 1, 2], false
] call _add;
...
[
    ...
    "Scale supply costs in the automatically generated vehicle build catalog. A value of 2 doubles that part of the price. Generated catalog prices require a mission restart.",
    ["Frontline - Campaign", "Economy"],
    [0, 4, 1, 2], false
] call _add;
...
[
    ...
    "Hours before the dedicated server issues its scheduled restart command, with advance player notifications. Uses the server's configured restart credentials. Live edits restart the countdown from the next check (within 15 seconds); Disabled cancels it.",
    ["Frontline - Campaign", "General"],
    [[0, 1, 2, 3, 4, 5, 6, 8], ["STR_PARAMS_DISABLED", "1", "2", "3", "4", "5", "6", "8"], 5], true
] call _add;
...
[
    ...
    "Victory condition",
    "Choose which objective categories must be captured to win the campaign. Campaign victory rules remain fixed for the active session.",
    ["Frontline - Campaign", "General"],
...
[
    ...
    "Capture area radius",
    "Radius in metres used to count opposing forces for sector control. Large towns use 1.4 times this radius. Fixed for the session so capture checks and civilian building baselines use the same radius.",
...
[
    ...
    "Daytime time acceleration",
    "Game-clock speed relative to real time. Applies immediately. 3x advances three game seconds per real second. Disable Four-times faster nights for the same speed all day and night.",
    ["Frontline - Campaign", "Time and weather"],
    [[8, 6, 4, 3, 2, 1], ["8x (3 real hours/day)", "6x (4 real hours/day)", "4x (6 real hours/day)", "3x (8 real hours/day)", "2x (12 real hours/day)", "1x (24 real hours/day)"], 1], true
] call _add;

[
    "GRLIB_shorter_nights", "CHECKBOX",
    "Four-times faster nights",
    "Between 20:00 (inclusive) and 04:00, multiply the selected daytime speed by four. For example, 3x becomes 12x. Disable for constant time acceleration. Applies immediately.",
    ["Frontline - Campaign", "Time and weather"],
    true, true
] call _add;
...
[
    ...
    "Weather mode",
    "Choose a fixed light-cloud sky, variable clear-to-cloudy weather, or the full weather range including heavy overcast. Live edits choose a new transition from the selected mode within five seconds; the sky changes gradually.",
    ["Frontline - Campaign", "Time and weather"],
