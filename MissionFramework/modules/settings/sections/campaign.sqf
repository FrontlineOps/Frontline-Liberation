...
[
    ...
    "Time acceleration",
    "Game-clock speed relative to real time. Changes apply on the next time-manager tick (normally within 10 seconds). Disable shorter nights for constant speed.",
...
[
    ...
    "Shorter nights",
    "Multiply the base speed by four at night (20:00-04:00): 3x becomes 12x. Disable for constant speed. Changes apply on the next time-manager tick.",
    ["Frontline - Campaign", "Time and weather"],
    true, true
] call _add;
