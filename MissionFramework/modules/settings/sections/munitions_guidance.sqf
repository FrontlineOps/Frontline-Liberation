...
[
    ...
    "Scale the ammunition-derived primary fragment count before applying the per-explosion limit. 1 preserves normal counts; 0 disables primary fragments only. Shared particle budgets still apply. Updated counts apply to new fragment requests; existing bursts are not recreated.",
    ["Frontline - Munitions & Guidance", "Advanced - effect capacity"],
    [0.0, 4.0, 1, 2], true
] call _add;
