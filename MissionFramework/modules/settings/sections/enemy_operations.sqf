...
[
    ...
    "Enable enemy resource accounting, resupply and funded strategic formations and infrastructure.",
    ["Frontline - Enemy Operations", "Command and resources"],
    true, false
] call _add;
...
[
    ...
    "Seconds before the first strategic planning pass after initialization.",
    ["Frontline - Enemy Operations", "Command and resources"],
    [1, 3600, 300, 0], false
] call _add;
...
[
    ...
    "Initial stock ratio",
    "Fraction of storage capacity filled when a new enemy strategic stock record is created.",
    ["Frontline - Enemy Operations", "Command and resources"],
...
[
    ...
    "Save and restore enemy task forces with the campaign so their surviving forces and operational state persist across restarts.",
    ["Frontline - Enemy Operations", "Command and resources"],
    true, false
] call _add;
