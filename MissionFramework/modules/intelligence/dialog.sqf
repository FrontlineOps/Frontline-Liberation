...
KPLIB_INTEL_CLIENT_SELECT_FILE = {
    ...
    private _text = "Capture enemy prisoners, escort them to a FOB or patrol base, then interrogate them. Sources reveal artillery, troop positions, fortifications and stock figures. Each ordinary source has a 20% chance to reveal a difficult operation. Its following stages are assigned automatically.";
    private _position = [];
