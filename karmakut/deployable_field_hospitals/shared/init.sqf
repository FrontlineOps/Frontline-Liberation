...
karma_deployableFieldHospitals_shared_fieldHospitalClassname = "vtx_stretcher_3"; // make sure to keep this in-sync with the associated entry in `KP_liberation_medical_facilities`.
