...
[] call compileFinal preprocessFileLineNumbers "scripts\libZeusActions\server\actions\airborne_reinforcements.sqf";
[] call compileFinal preprocessFileLineNumbers "scripts\libZeusActions\server\actions\airborne_battlegroup.sqf";
