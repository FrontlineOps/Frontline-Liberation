private _statement = {
	...
	[_marker] remoteExec ["motorized_battlegroup_remote", 2];
};


private _action = ["MotorizedBattlegroup", "Send Motorized", ["", [1,1,1,1]], _statement, { true }] call zen_context_menu_fnc_createAction;
