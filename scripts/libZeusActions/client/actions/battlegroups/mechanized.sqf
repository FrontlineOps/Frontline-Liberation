private _statement = {
	...
	[_marker] remoteExec ["mechanized_battlegroup_remote", 2];
};


private _action = ["MechanizedBattlegroup", "Send Mechanized", ["", [1,1,1,1]], _statement, { true }] call zen_context_menu_fnc_createAction;
