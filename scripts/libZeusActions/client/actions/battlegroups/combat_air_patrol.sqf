private _statement = {
	...
	[_marker] remoteExec ["combat_air_patrol_remote", 2];
};


private _action = ["CAPBattlegroup", "Send Combat Air Patrol", ["", [1,1,1,1]], _statement, { true }] call zen_context_menu_fnc_createAction;
