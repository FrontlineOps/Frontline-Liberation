...
if (_sector in sectors_bigtown || _sector in sectors_capture) then {
    ...
    [format ["Civilian sector %1 (%2) captured. Penalty: %3, Gain: %4", markerText _sector, _sector, _penalty, KP_liberation_cr_sector_gain - _penalty], "CIVREP"] call KPLIB_fnc_log;
};
